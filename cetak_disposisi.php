	...
	<div class="row" align="center">
		<div class="header">
			...
			<td colspan="3" bordered="#ffffff">
				<div align="center" style="border: solid; font-size: 10px;">Jl. Raya Pengasinan No.55, Sawangan Lama, Kec. Sawangan, Kota Depok, Jawa Barat 16517 Telp. (0251) 8601875
				</div>
			</td>
		</div>
		<br>
		...
		<table cellspacing="0" cellspacing="5" >
			...
			?>
				...
				<tr>
					<td id="right" width="200"><strong> Isi :</strong></td>
		...
		<div id="lead">
			<p>Mengetahui,<br>
			Kepala Sekolah SMK Bina Rahayu</p>
			<div style="height: 50px"></div>
			<p class="lead">H. M. Suhendra, S.Ag., M.Pd</p>
		</div>
	</div>	
