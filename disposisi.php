			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						...
						<a href="index.php?page=tambah_disposisi&id=<?php echo $data['id_surat']?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Disposisi</a>
						...
						<table id="disposisi" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<tr>
									<?php
										$no=1;
										$query2	= "SELECT * FROM disposisi JOIN surat_masuk ON disposisi.id_surat = surat_masuk.id_surat WHERE disposisi.id_surat='$id_surat'";
