	...
	<?php
			...
			if(!isset($_SESSION['username'])){
				...
				echo '<script>
					  ...
					  $querykaryawan	= "SELECT * FROM user WHERE username = '$username'";
 										$sqlkaryawan	= mysqli_query($connect, $querykaryawan);
 									    $datakaryawan= mysqli_fetch_array($sqlkaryawan);
		...
		<div class="container body">
			<div class="main_container">
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a href="index.php" class="site_title"><i class="fa fa-home"></i>  <b>SIMAS BINAR</b> </a>
						</div>
						...
						<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
							<div class="menu_section">
								...
								<ul class="nav side-menu">
									...
									<li><a><i class="fa fa-print"></i> Data Arsip <span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
							...
							?>
								<h3>Pengaturan</h3>
								<ul class="nav side-menu">
									<li><a href="index.php?page=users"><i class="fa fa-user"></i> Pengguna </a></li>
									<li><a><i class="fa fa-files-o"></i> Lainnya <span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
				...
				<footer>
					...
					<strong>©2020 Tata Usaha SMK Bina Rahayu</strong>
					</div>
					<div class="clearfix"></div>
				</footer>
			</div>
