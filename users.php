	...
	<div class="">
		...
		<div class="">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Data pengguna</h2>&nbsp; &nbsp;<a href="index.php?page=tambah_users" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah pengguna</a>
						...
						<table id="user" class="table table-striped table-bordered table-hover">
							<thead>
								<tr style="font-size: 13px;">
									...
									<th style="vertical-align: middle;"><center>NIP</center></th>
									...
									<th style="vertical-align: middle;"><center>Sebagai</center></th>
