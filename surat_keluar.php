 						...
 						<table id="surat_keluar" class="table table-striped table-bordered table-hover">
 							...
 							<tbody>
 								<tr>
 									<?php
 										$no=1;
 										$query	= "SELECT * FROM surat_keluar ORDER BY tanggal_kirim DESC";
 									...
 									<td>
 										<center>
 											<a href="index.php?page=edit_surat_keluar&id=<?php echo $data['id_surat']; ?>" class="btn btn-warning" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
 											<a href="index.php?page=hapus_surat_keluar&id=<?php echo $data['id_surat'] ?>" class="btn btn-danger" title="Hapus"><i class="fa fa-trash-o"></i></a>
 										</center>
 									</td>
 								</tr>
 								<?php 
