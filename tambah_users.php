	<?php
		...
		if (isset($_REQUEST['tambah'])) {
			...
			if (move_uploaded_file($tmp, $path)) {
				$query 		= "INSERT INTO user VALUES('$id', '$username', '$password', '$fullname', '$level', '$jenis_kelamin', '$foto')";
						...
						<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="id" class="form-control col-md-7 col-xs-12" required="required">
								</div>
							</div>
							<div class="item form-group">
							...
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Sebagai<span class="required">&nbsp; :</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
